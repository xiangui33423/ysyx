...
void Vysyx_23060096_npc___024root__traceInitSub0(Vysyx_23060096_npc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+59,"ysyx_23060096_npc en", false,-1);
        tracep->declBit(c+1,"ysyx_23060096_npc clk_en", false,-1);
        ...
        tracep->declBit(c+1,"ysyx_23060096_npc u_ImmGen clk", false,-1);
...
void Vysyx_23060096_npc___024root__traceFullSub0(Vysyx_23060096_npc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->fullBit(oldp+1,(vlSelf->ysyx_23060096_npc__DOT__clk_en));
        ...
        tracep->fullCData(oldp+58,((0x1fU & (vlSelf->inst 
                                             >> 7U))),5);
        tracep->fullBit(oldp+59,(vlSelf->ysyx_23060096_npc__DOT__en));
