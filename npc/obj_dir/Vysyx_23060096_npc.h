...
class Vysyx_23060096_npc VL_NOT_FINAL {
  ...
  public:
    ...
    Vysyx_23060096_npc___024root* const rootp;
    ...
    explicit Vysyx_23060096_npc(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vysyx_23060096_npc(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vysyx_23060096_npc();
  private:
    VL_UNCOPYABLE(Vysyx_23060096_npc);  ///< Copying not allowed
